...
printf " \e[1;92mv1.0, Author: @Skitz \e[0m   \e[1;92m\e[0m\n"
...
check1=$(curl -s -i "https://lichess.org/@/$username" -H "Accept-Language: en" -L | grep -o 'PAGE NOT FOUND!'; echo $?)
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Behance: \e[0m"
check1=$(curl -s -i "https://hackerone.com/$username" -H "Accept-Language: en" -L | grep -o 'Page not found'; echo $?)
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Behance: \e[0m"
check1=$(curl -s -i "https://bugcrowd.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP status 404.'; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Found!\e[0m https://bugcrowd.com/%s\n" $username
printf "https://bugcrowd.com/%s\n" $username >> $username.txt
fi
...
check1=$(curl -s -i "https://www.roblox.com/search/users?keyword=username=$username" -H "Accept-Language: en" -L | grep -o '404 Not Found' ; echo $?)
